...
<Tree>
  <Folder name="backend">
    <File name="Go REST API" />
    <File name="OIDC / sessions / permissions" />
    <File name="Deploy ingest / search / analytics" />
  </Folder>
  <Folder name="frontend">
    <File name="Next.js portal" />
    <File name="MDX renderer" />
    <File name="Admin console" />
    <File name="i18n catalogs" />
  </Folder>
  <Folder name="tools/docsctl">
    <File name="validate / build / package / deploy" />
  </Folder>
  <Folder name="mcp">
    <File name="stdio MCP server" />
    <File name="npx package" />
    <File name="Modex Skill" />
  </Folder>
</Tree>
