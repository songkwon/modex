...
var pluginCatalog = []PluginDef{
	{Key: "kroki", Name: "Kroki 图表", Category: "diagram", DefaultEnabled: true,
		Description: "用 Kroki 渲染 PlantUML、Graphviz、C4、DITAA、D2 等 diagram-as-code 代码块。",
